depth2col <-
function(dat, position.legend, palette, indexNames, palette.HCL.options, border.col, font.legend) {
    ...
    if (position.legend!="none") drawLegend(indexNames, colorl, position.legend=="bottom", border.col, font.legend)
